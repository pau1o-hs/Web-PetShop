  ...
  <div id="profile">
    ...
    <div id="petform">
      ...
      <section class="polaroid pol2" style="background-color:#2980B9;">
        <img
          src="../mockup/images/profile/pet2.jpg"
          width="100%"
          height="80%"
        />
        <p>Frajola</p>
      ...
      <section class="polaroid pol3" style="background-color:#2980B9;">
        <img
          src="../mockup/images/profile/pet3.jpg"
          width="100%"
          height="80%"
        />
        <p>Roger</p>
